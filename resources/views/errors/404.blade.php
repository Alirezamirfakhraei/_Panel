            ...
            <div class="preloader d-flex align-items-center justify-content-center">
                <div class="preloader-inner position-relative">
                    <div class="text-center">
                        <img class="jump mb-50 w-100" src="{{ asset('assets/imgs/loading.svg') }}" alt="loading">
                    ...
                    <div class="row mb-30">
                        <div class="col-12">
                            <div class="content-404 text-center mb-30">
                                ...
                                <p>بازدید از <a href="{{ route('panel.index') }}">صفحه نخست</a> یا در مورد مشکل <a href="contact.html">با ما تماس بگیرید</a></p>
                            </div>
                        </div>
                    </div>
                </div>
