                ...
                <div class="card-body p-4">
                    ...
                    <form action="{{route('auth.register.store')}}" method="POST">
                        ...
                        <div class="form-group">
                            <label for="userID">شماره همراه</label>
                            <input class="form-control @error('userID') is-invalid @enderror" value="{{ old('userID') }}"
                            type="text" id="userID" name="userID" placeholder="شماره همراه را وارد کنید">
                            @error('userID')
