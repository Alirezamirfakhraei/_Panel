@php use Mlk\Repairs\Models\Repair; @endphp
                        ...
                        <table class="table table-striped mb-0">
                            ...
                            @foreach($repairs as $repair)
                                <tr class="text-center">
                                    ...
                                    <td  class="badge align-middle badge-success mt-2">@lang($repair->status)</td>
                                    <td class="align-middle">{{explode(' ' , jdate($repair->created_at))[0]}}</td>
                                    <td class="align-middle">
                                        <div class="row">
                                            ...
                                            <!-- Modal -->
                                            <div class="modal fade modal-center" id="myModal{{$repair->id}}"
