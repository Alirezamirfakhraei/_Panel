...
class helper
{
    ...
    public function  showMessageError($error, $data, $message, $codeStatus): \Illuminate\Http\JsonResponse
    {
        return response()->json(['parameter' => ['error' => $error, 'data' => $data, 'message' => $message]], $codeStatus);
    }
